...
extension UIResponder {
    static let studyRoomNotificationLoginSucess = Notification.Name(rawValue: "studyRoomNotificationLoginSucess")
    static let studyRoomNotificationModifySucess = Notification.Name(rawValue: "studyRoomNotificationModifySucess")
    static let studyRoomNotificationMemberUpdate = Notification.Name(rawValue: "studyRoomNotificationMemberUpdate")
}
...
class ARSourceTimer: NSObject {
    ...
    class func start(_ timeInterval: TimeInterval = 1, timeCount: @escaping (_ time: String)->()){
